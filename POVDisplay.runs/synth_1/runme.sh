...
HD_PWD='C:/Users/Philip Glynn/POVDisplay/POVDisplay.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log arrays_data.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source arrays_data.tcl
