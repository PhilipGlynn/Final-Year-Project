...
HD_PWD='C:/Users/sgspe/Documents/project/Pov display/POVDisplay.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log povDisplay.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source povDisplay.tcl -notrace
