...
HD_PWD='C:/Users/sgspe/Documents/project/Pov display/POVDisplay.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log povDisplay.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source povDisplay.tcl
